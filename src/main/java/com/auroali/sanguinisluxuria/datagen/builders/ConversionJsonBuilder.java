...
public class ConversionJsonBuilder {
     ...
     */
    public void offerTo(SanguinisLuxuriaConversionsProvider.ConversionExporter exporter, Identifier id) {
        this.validate();
        exporter.export(new Provider(id, this.from, this.to, this.type, this.transformers, this.conditions));
    }
     ...
     * @param exporter the exporter to use
     */
    public void offerTo(SanguinisLuxuriaConversionsProvider.ConversionExporter exporter) {
        this.offerTo(exporter, this.getIdFromEntities(exporter.getDefaultNamespace()));
    }
