...
public class BLRecipeSerializers {
    ...
    public static void register() {
        ...
        Registry.register(Registry.RECIPE_SERIALIZER, BLResources.BLOOD_CAULDRON_ID, BLOOD_CAULDRON_SERIALIZER);
        Registry.register(Registry.RECIPE_SERIALIZER, BLResources.BLOOD_CAULDRON_FILL_ID, BLOOD_CAULDRON_FILL_SERIALIZER);
    }
}
