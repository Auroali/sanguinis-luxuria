...
public class BLItems {
    ...
    public static void register() {
        ...
        Registry.register(Registries.ITEM, BLResources.HUNGRY_DECAYED_LOG_ID, HUNGRY_DECAYED_LOG);
        Registry.register(Registries.ITEM, BLResources.STRIPPED_HUNGRY_DECAYED_LOG_ID, STRIPPED_HUNGRY_DECAYED_LOG);
        Registry.register(Registries.ITEM, BLResources.DECAYED_LOG_ID, DECAYED_LOG);
        Registry.register(Registries.ITEM, BLResources.STRIPPED_DECAYED_LOG_ID, STRIPPED_DECAYED_LOG);
        Registry.register(Registries.ITEM, BLResources.STRIPPED_DECAYED_WOOD_ID, STRIPPED_DECAYED_WOOD);
        Registry.register(Registries.ITEM, BLResources.DECAYED_WOOD_ID, DECAYED_WOOD);
        Registry.register(Registries.ITEM, BLResources.DECAYED_TWIGS_ID, DECAYED_TWIGS);
        Registry.register(Registries.ITEM, BLResources.GRAFTED_SAPLING_ID, GRAFTED_SAPLING);
        Registry.register(Registries.ITEM, BLResources.SILVER_PRESSURE_PLATE_ID, SILVER_PRESSURE_PLATE);
        Registry.register(Registries.ITEM, BLResources.DECAYED_PRESSURE_PLATE_ID, DECAYED_PRESSURE_PLATE);

        Registry.register(Registries.ITEM, BLResources.DECAYED_PLANKS_ID, DECAYED_PLANKS);
        Registry.register(Registries.ITEM, BLResources.DECAYED_FENCE_ID, DECAYED_FENCE);
        Registry.register(Registries.ITEM, BLResources.DECAYED_FENCE_GATE_ID, DECAYED_FENCE_GATE);
        Registry.register(Registries.ITEM, BLResources.DECAYED_STAIRS_ID, DECAYED_STAIRS);
        Registry.register(Registries.ITEM, BLResources.DECAYED_SLAB_ID, DECAYED_SLAB);
        Registry.register(Registries.ITEM, BLResources.DECAYED_BUTTON_ID, DECAYED_BUTTON);
        Registry.register(Registries.ITEM, BLResources.DECAYED_DOOR_ID, DECAYED_DOOR);
