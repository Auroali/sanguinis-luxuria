...
public class SLBlockSetTypes {
    public static final BlockSetType SILVER = new BlockSetTypeBuilder()
      ...
      .register(SLResources.SILVER_BLOCK_SET);
    public static final BlockSetType DECAYED_WOOD = BlockSetTypeBuilder.copyOf(BlockSetType.CRIMSON).register(SLResources.DECAYED_WOOD_BLOCK_SET);
    public static final WoodType DECAYED_WOOD_TYPE = WoodTypeBuilder.copyOf(WoodType.CRIMSON).register(SLResources.DECAYED_WOOD_BLOCK_SET, DECAYED_WOOD);
}
