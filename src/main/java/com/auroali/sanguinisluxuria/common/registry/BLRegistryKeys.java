...
public class BLRegistryKeys {
    ...
    public static final RegistryKey<Registry<Codec<? extends EntityConversionTransformer>>> CONVERSION_TRANSFORMERS = RegistryKey.ofRegistry(BLResources.CONVERSION_TRANSFORMERS);
    public static final RegistryKey<Registry<Codec<? extends EntityConversionCondition>>> CONVERSION_CONDITIONS = RegistryKey.ofRegistry(BLResources.CONVERSION_CONDITIONS);
